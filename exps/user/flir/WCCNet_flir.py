...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = 'datasets/alignedFLIR/'
        self.output_dir = "./exps_results"
        self.train_ann = "alignedFLIR_train.json"
        self.val_ann = "alignedFLIR_val.json"
        self.test_ann = "alignedFLIR_test.json"
